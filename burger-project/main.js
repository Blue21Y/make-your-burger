...
let allStylingClass = document.createElement("style");
allStylingClass.textContent = `.all {}`;
document.head.appendChild(allStylingClass);
...
let classStylingbun = document.createElement("style");
classStylingbun.textContent = `.myClassbun {min-height: 110px; margin-bottom: -30px;}`;
document.head.appendChild(classStylingbun);
...
ingredientsRemoveButtons[0].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/1.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[1].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/2.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[2].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/3.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[3].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/4.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[4].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/5.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[5].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/6.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[6].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/7.png"]`);
  ingRemove[0].remove();
});

ingredientsRemoveButtons[7].addEventListener("click", () => {
  let ingRemove = document.querySelectorAll(`.all>img[src="/8.png"]`);
  ingRemove[0].remove();
});
...
for (let i = 0; i < ingredientsAddButtons.length; i++) {
  ingredientsRemoveButtons[i].addEventListener("click", function () {
    ...
    let spanValue = parseInt(ingredientsSpans[i].textContent);

    switch (true) {
      case spanValue > 0 && priceChange:
        priceChange = true;
  ...
  ingredientsAddButtons[i].addEventListener("click", function () {
    ...
    switch (true) {
      case ingredientsSpans[i].textContent < 3 && appendedOnce:
        appendedOnce = true;
        arr.push(imgB);
        ingredientsDiv.append(arr[arr.length - 1]);
    ...
    ingredientsDiv.classList.add("all");
